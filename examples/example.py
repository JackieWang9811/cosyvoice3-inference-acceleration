...
def cosyvoice3_example():
    ...
    # text = '没关系，这一次没有做好也不要紧。你已经很努力了，慢慢来，我相信你一定会越来越好。'
    # instruct = 'You are a helpful assistant.<|endofprompt|>请用温柔、真诚、带一点笑意的语气说这句话，语速稍慢，像在鼓励一个刚刚经历失败的人。'

    for i, j in enumerate(cosyvoice.inference_zero_shot(
        # '没关系，这一次没有做好也不要紧。你已经很努力了，慢慢来，我相信你一定会越来越好。',
        # '没关系，这一次没有做好也不要紧。[breath]你已经很努力了。[laughter]慢慢来，我相信你一定会越来越好。',
        # '<laughter>你怎么连这个都忘啦</laughter>不过没关系，我们再来一遍。',
        '你已经做得<strong>很好</strong>了，只是这次还差一点点。',
        '请用温柔、真诚、带一点笑意的语气说这句话，语速稍慢，像在鼓励一个刚刚经历失败的人。<|endofprompt|>希望你以后能够做得比我还好呦。',
        # 'You are a helpful assistant.<|endofprompt|>请用温柔、真诚、带一点笑意的语气说这句话，语速稍慢，像在鼓励一个刚刚经历失败的人。',
        './asset/zero_shot_prompt.wav',
        stream=False
    )):
        torchaudio.save(f'zero_shot_{i}.wav', j['tts_speech'], cosyvoice.sample_rate)
        # torchaudio.save(f'instruct_0420_{i}.wav', j['tts_speech'], cosyvoice.sample_rate)
