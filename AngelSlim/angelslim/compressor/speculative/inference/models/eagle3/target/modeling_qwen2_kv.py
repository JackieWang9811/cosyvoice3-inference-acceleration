...
# Source: https://github.com/huggingface/transformers/blob/v4.51.3/src/transformers/models/qwen2/modeling_qwen2.py # noqa: E501
    ...
    def _update_causal_mask(
        ...
        # DynamicCache or no cache
            ...
            target_length = (
                ...
                else past_seen_tokens + sequence_length  # [MODIFIED]
            )
